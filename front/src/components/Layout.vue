      ...
      <a-layout-header style="background: #fff; padding: 0">
        <div class="user-info">
          ...
          <div style="margin-right: 10px">
            <p style="margin-bottom: 0; min-width: 120px; text-align: center">{{ userInfo.name }}</p>
            <p style="text-align: center; font-size: 0.8rem; font-weight: bold " v-if="userInfo.staff">
              Администратор
            </p>
          </div>
          <a-icon
