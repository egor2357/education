    ...
    <div class="presence-chart__table">
      ...
      <div class="presence-chart__table-body">
        <div class="presence-chart__table-body-row" v-for="row in tableData.specialists" :key="row.id">
          <div class="presence-chart__table-body-specialist-cell">
            ...
            >
              ...
              >
                ...
                <a-menu slot="overlay">
                  ...
                  <a-menu-item key="2" @click="$emit('displayDeleteConfirm', {specialist: row.fullName, presence: interval.editableData})">
                    <span> Удалить </span>
                  </a-menu-item>
                </a-menu>
              </a-dropdown>
