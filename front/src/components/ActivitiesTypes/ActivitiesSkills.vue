      ...
      <div>
        <div class="table-header">
          ...
          <div
            ...
            :key="activity.id"
            class="table-header__column table-header__column_activity"
          >
            <div
                ...
                <div class="table-row__container">
                  ...
                  >
                    ...
                    <div
                      v-for="activity in activities"
                      :key="activity.id"
                      class="table-row__column_activity"
                    >
                      <a-checkbox
                        :checked="
                          !!handledActivities[activity.id].includes(skill.id)
                        "
...
export default {
  ...
  computed: {
    ...
    handledActivities() {
      let res = {};
      for (let activity of this.activities) res[activity.id] = activity.skills;
      return res;
    },
  },
  async created() {
